...
export const CreateChannelMessageBody = zod.object({
  ...
  "attachments": zod.array(zod.instanceof(File)).describe('A list of attachment files for the message.')
})
...
export const ListChannelMessagesParams = zod.object({
  "workspaceId": zod.string().uuid().describe('The ID of the workspace.'),
  "channelId": zod.string().uuid().describe('The unique identifier of the channel.'),
  "page": zod.number().min(1).default(listChannelMessagesPathPageDefault).describe('The page number to retrieve.'),
  "pageSize": zod.number().min(1).max(listChannelMessagesPathPageSizeMax).default(listChannelMessagesPathPageSizeDefault).describe('The number of items to retrieve per page.')
})
...
export const ListChannelMessagesResponse = zod.object({
  ...
  "timestamp": zod.string().datetime({"offset":true}).describe('The time when the message was sent.'),
  "attachments": zod.array(zod.object({
  "id": zod.string().describe('Unique identifier for the attachment.'),
  "filename": zod.string().describe('Name of the attached file.'),
  "url": zod.string().url().describe('URL where the attachment can be accessed.'),
  "size": zod.number().describe('Size of the attached file in bytes.')
})).optional().describe('List of attachments included in the message.'),
  "reactions": zod.array(zod.object({
  "id": zod.string().describe('The unique identifier of the reaction.'),
...
export const ListDirectChatMessagesParams = zod.object({
  "workspaceId": zod.string().uuid().describe('The ID of the workspace.'),
  "directChatId": zod.string().uuid().describe('The ID of the direct chat.'),
  "page": zod.number().min(1).default(listDirectChatMessagesPathPageDefault).describe('The page number to retrieve.'),
  "pageSize": zod.number().min(1).max(listDirectChatMessagesPathPageSizeMax).default(listDirectChatMessagesPathPageSizeDefault).describe('The number of items to retrieve per page.')
})
