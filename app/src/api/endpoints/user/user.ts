...
export const updateCurrentUserProfile = (
  ...
  return axios.patch(`/users/me`, formData, options);
};
...
export const getUserProfileByEmail = (
  ...
  return axios.get(`/users/${emailRegex}`, options);
};

export const getGetUserProfileByEmailQueryKey = (emailRegex: string) => {
  return [`/users/${emailRegex}`] as const;
};
...
export const removeUserFromWorkspace = (
  ...
  return axios.delete(`/users/${userId}/workspaces/${workspaceId}`, options);
};
