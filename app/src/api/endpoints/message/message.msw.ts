...
export const getCreateChannelMessageMockHandler = (
  overrideResponse?:
    | void
    | ((
...
export const getUpdateChannelMessageMockHandler = (
  overrideResponse?:
    | void
    | ((
...
export const getDeleteChannelMessageMockHandler = (
  overrideResponse?:
    | void
    | ((
...
export const getCreateDirectChatMessageMockHandler = (
  overrideResponse?:
    | void
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
  ...
  return http.post(
    "*/workspaces/:workspaceId/direct-chats/:directChatId/messages",
    async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
      if (typeof overrideResponse === "function") {
        await overrideResponse(info);
      }
...
export const getUpdateDirectChatMessageMockHandler = (
  overrideResponse?:
    | void
    | ((
        info: Parameters<Parameters<typeof http.patch>[1]>[0],
  ...
  return http.patch(
    "*/workspaces/:workspaceId/direct-chats/:directChatId/messages/:messageId",
    async (info: Parameters<Parameters<typeof http.patch>[1]>[0]) => {
      if (typeof overrideResponse === "function") {
        await overrideResponse(info);
      }
...
export const getDeleteDirectChatMessageMockHandler = (
  overrideResponse?:
    | void
    | ((
        info: Parameters<Parameters<typeof http.delete>[1]>[0],
